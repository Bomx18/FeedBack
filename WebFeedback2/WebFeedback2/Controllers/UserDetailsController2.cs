...
namespace WebFeedback2.Controllers
{
    ...
    [ApiController]
    public class UserDetailsController2 : ControllerBase
    {
        private readonly UserDetailContext _context;

        public UserDetailsController2(UserDetailContext context)
        {
            _context = context;
        }

        // GET: api/UserDetailsController2
        [HttpGet]
        ...
        // GET: api/UserDetailsController2/5
        [HttpGet("{id}")]
        ...
        // PUT: api/UserDetailsController2/5
        [HttpPut("{id}")]
        ...
        // POST: api/UserDetailsController2
        [HttpPost]
        ...
        // DELETE: api/UserDetailsController2/5
        [HttpDelete("{id}")]
